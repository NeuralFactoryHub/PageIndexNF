...
When writing plans, reference project-specific skills for the engineer to use during implementation. Check `.claude/skills/` for available skills or read `project.yml` for service-to-skill mappings.

**Example in plan:**
```markdown
**Step 2: Create API route**
Reference: @<skill-name> for route handler patterns
```
